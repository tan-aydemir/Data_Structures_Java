 ...
 *     name: Tan Aydemir
 *     username: tanaydemir1@gmail.com
 */
...
public class LinkedTree {
    ...
    /*
     * Processes the integer keys in the specified array from 
    ...
    public LLList delete(int key) {
        ...
        // Deletes the node (if any) and return the removed data item.
    ...
    private void deleteNode(Node toDelete, Node parent) {
        if (toDelete.left != null && toDelete.right != null) {
            ...
            // Recursively deletes the replacement item's old node.
    ...
    public boolean anyGreater(int v) {
        // makes the first call to the recursive method,
        // passes in the root of the tree as a whole
    ...
    private class PreorderIterator implements LinkedTreeIterator {
        ...
        public int next() {
            ...
            // Stores a copy of the key to be returned.
            ...
            if (nextNode.left != null) {
                ...
                // We need to travel back up the tree until we find a node
